      ...
      <div className="px-4 sm:px-6 py-6 sm:py-8">
        <div className="max-w-6xl mx-auto">
          ...
          <div
            ...
            className="bg-gradient-to-r cursor-pointer from-indigo-600 via-purple-600 to-indigo-700 rounded-2xl p-6 sm:p-8 mb-6 sm:mb-8 shadow-2xl hover:shadow-3xl transition-all duration-500 transform"
          >
            <div className="text-center">
              <div className="mb-4 sm:mb-6">
                ...
                <p className="text-indigo-100 text-base sm:text-lg">
                  Mulai perjalanan karier Anda dengan CV yang ATS-friendly dan
                  modern
                </p>
              </div>

              <div className="group relative inline-flex items-center justify-center px-6 sm:px-8 py-3 sm:py-4 bg-white text-indigo-600 font-bold text-base sm:text-lg rounded-xl shadow-lg hover:shadow-2xl transition-all duration-300 hover:scale-105 focus:outline-none focus:ring-4 focus:ring-white/50">
